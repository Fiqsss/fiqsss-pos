...
new class extends Component {
    ...
    public $kategoriId;
    public $data;
    public $id, $barcode, $kategori, $namabarang, $merk, $stock, $harga_jual, $harga_beli, $satuan;

    public function mount($data)
    {
        $this->id = $data->id;
        $this->barcode = $data->barcode;
        $this->kategori = $data->kategori_id;
        $this->namabarang = $data->nama_barang;
        $this->merk = $data->merk;
        $this->stock = $data->stock;
        $this->harga_jual = $data->harga_jual;
        $this->harga_beli = $data->harga_beli;
        $this->satuan = $data->satuan_barang;
    }
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <select wire:model='kategori' id="kategori"
                                class="form-control @error('namabarang') is-invalid @enderror " style="width: 100%;">
